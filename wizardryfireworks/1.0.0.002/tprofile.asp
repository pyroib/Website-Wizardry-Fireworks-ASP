...
DIM strSQL, dbConn, dbRst, string, icount, random_number, q, b, prefix
...
<!---  start footprint and login //-->
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td width="650">
								<table border="0" width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid #cccccc;"><tr><td style="background: #ffffff;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="/default.asp">Home</a> || <a href="/tprofile.asp">Team Profile</a></td></tr></table>
							</td>
							<td width="2"></td>
							<td>
...
%>
	<tr>
		<td align="center">
			<table border="0" width="100%" cellpadding="7" cellspacing="0" style="text-align:left;">
				<tr>
					<td valign="top" style="font-size:18px; text-transform:capitalize;"><%= dbRst("staff_name") %></td>
					<td valign="top" style="font-size:12px; text-transform:capitalize; text-align:center;"><%= dbRst("staff_pos") %></td>
				</tr>
				<tr>
					<td valign="top"><%= dbRst("staff_exp") %></td>
					<td valign="top"><img src="/images/staff/<%= dbRst("staff_name") %>.jpg" border="0"></td>
				</tr>
			</table>
<%
	q = q + 1
